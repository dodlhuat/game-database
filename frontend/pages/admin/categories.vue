              ...
              <tbody>
                <template v-for="cat in categories" :key="cat.id">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-row">
                        <button class="action-btn" @click="openEdit(cat)">
                        ...
                        <button class="action-btn action-btn--danger" @click="remove(cat)">
                  ...
                  <tr v-for="child in cat.children" :key="child.id" class="child-row">
                    ...
                    <td>
                      <div class="action-row">
                        <button class="action-btn" @click="openEdit(child)">
                          {{ $t('admin.actions.edit') }}
                        </button>
                        <button
                          class="action-btn"
                        ...
                        <button class="action-btn action-btn--danger" @click="remove(child)">
                          {{ $t('admin.actions.delete') }}
                        </button>
                      </div>
                    </td>
