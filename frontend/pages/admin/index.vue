        ...
        <template v-else-if="stats">
          ...
          <div class="ops-grid">
            ...
            >
              ...
              <span
                class="ops-card__sub"
                :class="{ 'ops-card__sub--red': stats.loans.overdue > 0 }"
              >
...
.attention-item {
  ...
  border-bottom: 1px solid rgba(212, 146, 30, 0.1);
