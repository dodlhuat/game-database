          ...
          <section class="dash-section">
            ...
            <form class="settings-form" @submit.prevent="save">
              <div class="settings-grid">
                ...
                <div class="form-field">
                  <label class="form-label">{{
                    $t('admin.loan_settings.loan_duration_weeks')
                  }}</label>
                  <input
                    v-model.number="form.loan_duration_weeks"
                    class="form-input"
                    type="number"
                    min="1"
                    required
                ...
                <div class="form-field">
                  ...
                  <input
                    v-model.number="form.max_extensions"
                    class="form-input"
                    type="number"
                    min="0"
                    required
              ...
              <div class="settings-section-title">
                {{ $t('admin.loan_settings.condition_section') }}
              </div>
              <div class="settings-grid">
                <div class="form-field">
                  <label class="form-label">{{
                    $t('admin.loan_settings.condition_very_good_after')
                  }}</label>
                  <input
                    v-model.number="form.condition_very_good_after"
                    class="form-input"
                    type="number"
                    min="1"
                    required
                  />
                  <p class="form-hint">
                    {{ $t('admin.loan_settings.condition_very_good_after_hint') }}
                  </p>
                </div>
                <div class="form-field">
                  <label class="form-label">{{
                    $t('admin.loan_settings.condition_good_after')
                  }}</label>
                  <input
                    v-model.number="form.condition_good_after"
                    class="form-input"
                    type="number"
                    min="1"
                    required
                ...
                <div class="form-field">
                  <label class="form-label">{{
                    $t('admin.loan_settings.deposit_pct_very_good')
                  }}</label>
                  <input
                    v-model.number="form.deposit_pct_very_good"
                    class="form-input"
                    type="number"
                    min="0"
                    max="100"
                  ...
                  />
                  <p class="form-hint">
                    {{ $t('admin.loan_settings.deposit_pct_very_good_hint') }}
                  </p>
                </div>
                <div class="form-field">
                  <label class="form-label">{{ $t('admin.loan_settings.deposit_pct_good') }}</label>
                  <input
                    v-model.number="form.deposit_pct_good"
                    class="form-input"
                    type="number"
                    min="0"
                    max="100"
              ...
              <div class="settings-actions">
                <UiButton type="submit" :loading="saving">{{
                  $t('admin.loan_settings.save_btn')
                }}</UiButton>
          ...
          <section class="dash-section">
            ...
            <div class="preview-list">
              <div v-for="(item, i) in preview" :key="i" class="preview-item">
                ...
                <span class="preview-item__due">{{
                  $t('admin.loan_settings.preview_return', { date: item.due })
                }}</span>
              </div>
            </div>
          </section>
...
const api = useApi()
const { formatDate } = useLoanSettings()
const { t } = useI18n()
...
const preview = computed(() => {
  ...
  deadline.setDate(deadline.getDate() + form.value.grace_days)
