    ...
    <section class="page-hero">
      ...
      <div class="page-hero__body">
        ...
        <div class="token-balance">
          ...
          <div
            v-if="(auth.user?.tokens_blocked ?? 0) > 0"
            class="token-balance__item token-balance__item--blocked"
          >
          ...
          <div class="token-balance__item token-balance__item--free">
            <span class="token-balance__val">{{
              (auth.user?.tokens ?? 0) - (auth.user?.tokens_blocked ?? 0)
            }}</span>
          ...
          <div class="tx-section">
            ...
            <div v-else>
                ...
                <tbody>
                  <tr v-for="tx in transactions" :key="tx.id" class="tx-row">
                    ...
                    <td class="tx-row__desc">
                      <span class="tx-type-badge" :class="txClass(tx.type)">{{
                        txLabel(tx.type)
                      }}</span>
              ...
              <div v-if="txMeta.last_page > 1" class="tx-pagination">
                <button class="action-btn" :disabled="txPage === 1" @click="loadTx(txPage - 1)">
                  ←
                </button>
